...
public class SimpleStringBuffer {
   ...
   public synchronized SimpleStringBuffer append(String str) {
      String s = str;
      if (s==null) s = "null"; //convert null to a string as a string  concatenated to a null value is a string (eg.anunull)
   ...
   {
	   SimpleStringBuffer ssb=new SimpleStringBuffer();
	   ssb.append(null);
	   String s="anu"+null;
